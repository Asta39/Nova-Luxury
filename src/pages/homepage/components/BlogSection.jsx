      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts?.map((post) => (
            <article
              key={post?.id}
              className="bg-card rounded-lg luxury-shadow-card hover:luxury-shadow-modal luxury-transition overflow-hidden group"
            >
              <div className="relative overflow-hidden">
                <Image
                  src={post?.image}
                  alt={post?.title}
                  className="w-full h-48 object-cover group-hover:scale-105 luxury-transition"
                />
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-primary mb-3 leading-tight group-hover:text-secondary luxury-transition">
                  {post?.title}
                </h3>
