...
// --- (Importing local page components) ---
...
// --- 1. IMPORT THE NEW SERVICEHERO COMPONENT ---
...
const IndividualServicePages = () => {
  ...
  // --- 2. UPDATED SERVICES DATA TO USE 'videoUrl' CONSISTENTLY ---
  const servicesData = {
    wedding: {
      name: "Wedding Celebrations",
      category: "Luxury Weddings",
      videoUrl: "/assets/videos/Wedding.mp4", // Replaced heroImage
      ...
      overviewImages: [
        ...
        { src: "/assets/images/wedding-2.webp" },
        { src: "/assets/images/wedding-3.webp" },
        { src: "/assets/images/wedding-4.webp" }
      ],
      offerings: [
        { title: "Traditional Ceremonies", description: "Honor your heritage with authentic traditional wedding ceremonies that celebrate your cultural roots while incorporating modern luxury elements.", image: "/assets/images/wedding-14.webp", features: ["Cultural ceremony coordination", "Traditional attire consultation", "Authentic décor elements", "Elder and family integration", "Custom ritual planning", "Heritage photography"] },
        { title: "Modern Celebrations", description: "Contemporary wedding experiences featuring cutting-edge design, innovative technology, and personalized touches that reflect your modern love story.", image: "/assets/images/wedding-15.webp", features: ["Modern venue styling", "Technology integration", "Contemporary entertainment", "Innovative catering concepts", "Social media coordination", "Luxury transportation"] },
        { title: "Destination Weddings", description: "Exotic destination weddings in Kenya's most breathtaking locations, from coastal resorts to safari lodges, creating unforgettable experiences.", image: "/assets/images/wedding-16.webp", features: ["Location scouting", "Travel coordination", "Accommodation management", "Local vendor partnerships", "Guest experience planning", "Legal documentation support"] }
      ],
      planningProcess: [
      ...
      portfolioImages: [
        { src: "/assets/images/wedding-5.webp" },
        { src: "/assets/images/wedding-6.webp" },
        { src: "/assets/images/wedding-7.webp" },
        { src: "/assets/images/wedding-8.webp" },
        { src: "/assets/images/wedding-9.webp" },
        { src: "/assets/images/wedding-10.webp" },
        { src: "/assets/images/wedding-11.webp" },
        { src: "/assets/images/wedding-12.webp" },
        { src: "/assets/images/wedding-13.webp" }
      ],
      testimonials: [
    ...
    corporate: {
      ...
      videoUrl: "/assets/videos/wedding-video.mp4",
    ...
    birthday: {
        ...
        videoUrl: "/assets/videos/birthday-celebrations-video.mp4", // Replaced heroImage
    ...
    // ... (Continue this pattern for 'private', 'milestone', and 'family', replacing heroImage with videoUrl)
    private: {
        name: "Private Luxury Events",
        category: "Exclusive Experiences",
        videoUrl: "/assets/videos/private-luxury-video.mp4",
...
{ question: "What security measures can you coordinate?", answer: "We can coordinate professional security services, privacy management, controlled access, and discreet protection for high-profile events requiring enhanced security measures." }
      ...
      milestone: {
        ...
        videoUrl: "/assets/videos/milestone-celebrations-video.mp4",
...
overviewImages: [
{ src: "/assets/images/mile-1.webp" },
{ src: "/assets/images/mile-2.webp" },
{ src: "/assets/images/mile-3.webp" },
{ src: "/assets/images/mile-4.webp" }
],
offerings: [
{ title: "Academic Achievements", description: "Celebrate educational milestones with graduations, academic honors, and scholarship celebrations that recognize hard work and achievement.", image: "/assets/images/mile-11.webp", features: ["Graduation ceremony coordination", "Academic honor celebrations", "Scholarship award ceremonies", "Educational milestone parties", "Family gathering coordination", "Achievement documentation"] },
{ title: "Career Milestones", description: "Honor professional achievements with retirement parties, promotion celebrations, and career recognition events that acknowledge dedication and success.", image: "/assets/images/mile-12.webp", features: ["Retirement celebration planning", "Promotion recognition events", "Career achievement honors", "Professional networking events", "Legacy project showcases", "Colleague coordination"] },
{ title: "Life Transitions", description: "Mark significant life transitions with coming of age ceremonies, anniversary celebrations, and personal achievement recognition events.", image: "/assets/images/mile-10.webp", features: ["Coming of age ceremonies", "Anniversary celebrations", "Personal achievement recognition", "Life transition ceremonies", "Family tradition planning", "Cultural ceremony integration"] }
],
planningProcess: [
...
portfolioImages: [
{ src: "/assets/images/mile-5.webp" },
{ src: "/assets/images/mile-6.webp" },
{ src: "/assets/images/mile-7.webp" },
{ src: "/assets/images/mile-8.webp" },
{ src: "/assets/images/mile-9.webp" },
{ src: "/assets/images/mile-10.webp" }
],
testimonials: [
...
overviewImages: [
{ src: "/assets/images/family-1.webp" },
{ src: "/assets/images/family-2.webp" },
{ src: "/assets/images/family-3.webp" },
{ src: "/assets/images/family-4.webp" }
],
offerings: [
  ...
  if (!currentService) {
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <Header />
            {/* Using a simplified NotFound component directly */}
  ...
  return (
    <>
      <Helmet>
        ...
        {/* OG Image should point to a relevant static image, maybe a poster frame from the video */}
        <meta property="og:image" content={`/assets/images/og-${serviceType}.jpg`} /> 
      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          {/* --- 3. REPLACED OLD HERO SECTION WITH THE NEW COMPONENT --- */}
        ...
        <div className="relative z-10 bg-background">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 space-y-16">
            ...
            <section id="contact-form" className="py-16">
                {/* ... The rest of your contact form and other sections remain exactly the same ... */}
             ...
             {/* ... The final section also remains the same ... */}
